export const contractAddress = "0x00FA82eA9BE4E24ec6D7ED86ef93bfe85b9a3e68";
...
export const contractAbi = [
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_maxGifts", type: "uint256" },
  ...
  {
    inputs: [
      { internalType: "uint8", name: "numTokens", type: "uint8" },
  ...
  {
    inputs: [{ internalType: "address", name: "_bouncer", type: "address" }],
    name: "setBouncer",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
